 <footer class="mt-16 bg-blue-500 flex-none">
     <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
         <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
             <div>
                 <img src="./assets/logo/logo.png" class="mr-5 h-6 sm:h-9 rounded-full" alt="logo" />
                 <p class="max-w-xs mt-4 text-sm text-white">
                     Si no encuentras lo que buscas ... entonces es que no existe.
                 </p>
             ...
             <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
                 <div>
                     ...
                     <nav class="flex flex-col mt-4 space-y-2 text-sm text-white">
                         <a class="hover:opacity-75" href> Acerca de </a>
                         <a class="hover:opacity-75" href> Nuestro Equipo </a>
                         <a class="hover:opacity-75" href> Historia </a>
                 ...
                 <div>
                     ...
                     <nav class="flex flex-col mt-4 space-y-2 text-sm text-white">
                         ...
                         <a class="hover:opacity-75" href> Política de devolución </a>
         ...
         <p class="mt-8 text-xs text-gray-800">
             © 2024 David Pecharromán. All rights reserved.
         </p>
     </div>
 </footer>